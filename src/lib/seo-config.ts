...
export const seoConfig = {
  ...
  siteDescription: "Mohamed Khairi Bouzid is a passionate full-stack developer and computer engineering student at ESPRIT, specializing in web development, blockchain technology, and modern JavaScript frameworks. Explore my portfolio showcasing innovative projects and technical expertise.",
  siteUrl: "https://www.mohamedkhairibouzid.engineer/", // TODO: Replace with your actual domain
  ...
  pages: {
    home: {
      title: "Mohamed Khairi Bouzid - Full Stack Developer & Computer Engineering Student",
      description: "Welcome to Mohamed Khairi Bouzid's portfolio - showcasing innovative web development projects and technical expertise.",
    },
    about: {
      title: "About Mohamed Khairi Bouzid",
      description: "Learn about Mohamed Khairi Bouzid's background, education, and passion for web development and blockchain technology.",
    },
    projects: {
      title: "Projects by Mohamed Khairi Bouzid",
      description: "Explore innovative web development projects including Carbon Calculator, AI Mock Interview, and more.",
    },
    skills: {
      title: "Technical Skills - Mohamed Khairi Bouzid",
      description: "Discover Mohamed Khairi Bouzid's technical expertise in React, Next.js, Node.js, blockchain, and modern web technologies.",
    },
    experience: {
      title: "Professional Experience - Mohamed Khairi Bouzid",
      description: "Mohamed Khairi Bouzid's professional journey and internship experience in software development.",
    },
    contact: {
      title: "Contact Mohamed Khairi Bouzid",
      description: "Get in touch with Mohamed Khairi Bouzid for collaboration opportunities and professional inquiries.",
    },
  },
};
