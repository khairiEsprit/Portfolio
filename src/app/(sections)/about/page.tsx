  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center pt-2 pb-20">
      <div className="text-justify animate_in p-6 md:w-1/2">
        ...
        Im passionate software developer with a proven track record of building innovative and scalable web applications.
          <br />
          <br />
          My educational background includes a  Bachelor degree in Computer Science from the Higher Institute of Computer Science of Mahdia.
