...
import MobilePerformanceMonitor, {
  PerformanceOptimizationSuggestions,
} from "@/components/MobilePerformanceMonitor";
        ...
        <ThemeProvider attribute="class">
          <TooltipProvider delayDuration={0}>
            <div className="relative overflow-hidden min-h-screen bg-background">
              ...
              {/* Animated background blobs - reduced on mobile for better performance */}
              <div className="hidden lg:block fixed top-10 left-1/3 w-[400px] h-[400px] bg-blue-200/15 dark:bg-blue-800/8 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-blob -z-10" />
              <div className="hidden lg:block fixed top-0 right-4 w-[400px] h-[400px] bg-purple-200/15 dark:bg-purple-800/8 mix-blend-multiply rounded-full filter blur-3xl opacity-60 animate-blob animation-delay-2000 -z-10" />
              <div className="hidden lg:block fixed bottom-20 left-20 w-[400px] h-[400px] bg-pink-200/15 dark:bg-pink-800/8 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-blob animation-delay-4000 -z-10" />
              <div className="hidden lg:block fixed -bottom-8 right-1/4 w-[400px] h-[400px] bg-green-200/15 dark:bg-green-800/8 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-blob animation-delay-4000 -z-10" />
            ...
            {/* Enhanced dot pattern - reduced on mobile for better performance */}
            <DotPattern
              className={cn(
                "fixed inset-0 [mask-image:radial-gradient(600px_circle_at_center,white,transparent)] opacity-30 dark:opacity-20 lg:opacity-50 lg:dark:opacity-30 -z-30"
              )}
            />
          </TooltipProvider>
        </ThemeProvider>
