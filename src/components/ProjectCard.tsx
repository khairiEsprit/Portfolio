...
// Mobile-optimized tilt options
const mobileOptions = {
  reverse: false,
  max: 15, // Reduced tilt on mobile
  perspective: 1000,
  scale: 1.02, // Minimal scale on mobile
  speed: 500, // Faster response
  transition: true,
  axis: null,
  reset: true,
...
const ProjectCard = ({ project, index, className }: ProjectCardProps) => {
  ...
  const cardVariants = {
    ...
    visible: {
      ...
      transition: {
        ...
        delay: isMobile ? Math.min(index * 0.05, 0.2) : index * 0.1, // Reduced delay on mobile
        ease: [0.16, 1, 0.3, 1],
      },
    },
  };
  ...
  return (
    <MotionConfig reducedMotion="user">
      ...
      >
        <Tilt options={isMobile ? mobileOptions : defaultOptions}>
